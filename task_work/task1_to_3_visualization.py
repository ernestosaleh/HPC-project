...
#load data 
data = np.load('task1_to_3_result.npz', allow_pickle=True)
...
for building_id in building_ids:  
    ...
    plt.savefig(f'images/floor_plan_ID{building_id}.png', bbox_inches='tight')
    plt.close()
...
plt.savefig(f'images/task1_to_3_execution_time.png', bbox_inches='tight')
plt.close()